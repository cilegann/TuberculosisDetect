...
if __name__ == "__main__":
    ...
    parser.add_arguments('--width',type=int,default=420)
    parser.add_arguments('--height',type=int,default=131)
    parser.add_arguments('--balance',action='store_true',help="Balance data by undersampling the majiroty data")
    parser.add_arguments('--n_labels',type=int,default=3)
