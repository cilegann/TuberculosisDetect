...
def get_model(args):
    ...
    for i,l in enumerate(premodel.layers):
        ...
        premodel.layers[i].name='yolo_'+l.name

    hiddena=Flatten()(premodel.get_layer('yolo_leaky_re_lu_18').output)
    hiddena=Dropout(0.7)(hiddena)
    ...
    hiddenb=Flatten()(premodel.get_layer('yolo_leaky_re_lu_18').output)
    hiddenb=Dropout(0.7)(hiddenb)
