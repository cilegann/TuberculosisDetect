...
def get_model(args):
    ...
    hiddena=Dropout(0.7)(normalized)
...
def train(args):
    ...
    cbrlr=ReduceLROnPlateau(monitor='val_loss',verbose=1,patience=5,cool_down=3,min_lr=0.00001)
    ...
    try:
        model.fit_generator(
            ...
            epochs=args.epochs,
            callbacks=[cblog,cbtb,cbckpt,cbckptw,cbrlr,cbeval]
